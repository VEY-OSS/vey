...
use vey_crypto_mb::{RSA_3K_LEN, RsaSlot, private_crt_mb8, status_ok};
...
fn rsa_3k_sign_pkcs1() {
    ...
    let mut slots = [
        RsaSlot::<RSA_3K_LEN>::prepare_pkcs1_sign(&key0, Nid::SHA256, &common::SHA256_DIGEST)
            .expect("prepare0"),
        RsaSlot::<RSA_3K_LEN>::prepare_pkcs1_sign(&key1, Nid::SHA256, &common::SHA256_DIGEST)
            .expect("prepare1"),
    ];
