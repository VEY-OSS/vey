...
vey_proxy_ctl escaper float_passive publish '{"type":"http","addr":"127.0.0.1:7080"}'
...
vey_proxy_ctl escaper float_passive publish '{"type":"socks5s","addr":"127.0.0.1:6443", "tls_name": "vey-proxy.local"}'
