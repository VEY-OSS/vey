...
Set stream-dump configuration. This can be used to export streams in a format
compatible with Wireshark ``udpdump``.
...
.. availability::
   ...
   - ``vey-proxy``: changed in ``1.7.11``: allow str value
...
* supported_groups
  ...
  **default**: not set
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.7.35``
...
* permute_extensions
  ...
  **default**: not set, the default value may vary between different OpenSSL variants
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.7.36``
...
* insecure:
  ...
  **default**: false
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.11.0``
...
* steal_forwarded_for
  ...
  **default**: false
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.9.2``
...
* max_frame_size
  ...
  **default**: 256KiB, **min**: 16K, **max**: 16M - 1
  ...
  .. availability::
     ...
     - ``vey-proxy``: changed in ``1.11.3``: adjust the value to be in the range *min*-*max* automatically
...
* stream_window_size
  ...
  **default**: 1MiB
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.11.7``
...
* forward_max_idle_count
  ...
  **optional**, **type**: usize
  ...
  The actual idle check interval is defined by the surrounding server
  configuration.
