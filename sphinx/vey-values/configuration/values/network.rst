...
.. availability::
   ...
   - ``vey-proxy``: available since ``1.7.31``
...
.. availability::
   ...
   - ``vey-proxy``: changed in ``1.11.4``: support interface index
...
**yaml value**: map | :ref:`sockaddr str <conf_value_sockaddr_str>`

Weighted socket address suitable for use in a selective vector.
...
String containing a valid HTTP header value.
...
* idle_timeout
  ...
  **default**: 5m
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.11.1``
...
* keepalive
  ...
  **default**: not set
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.11.9``
...
* dns-over-http/3 | doh3 | h3
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.7.27``
...
* dns-over-quic | doq | quic
  ...
  .. availability::
     ...
     - ``vey-proxy``: available since ``1.7.15``
