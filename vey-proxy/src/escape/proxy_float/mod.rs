...
impl Escaper for ProxyFloatEscaper {
    ...
    async fn tcp_setup_connection(
        ...
        peer.tcp_setup_connection(self, task_conf, egress_notes, task_notes, task_stats)
            .await
    }
    ...
    async fn udp_setup_connection(
        ...
        peer.udp_setup_connection(self, task_conf, egress_notes, task_notes, task_stats)
            .await
    }
    ...
    async fn udp_setup_relay(
        ...
        let peer = self
            .select_peer(task_notes)
            .map_err(UdpConnectError::EscaperNotUsable)?;
        peer.udp_setup_relay(self, task_conf, egress_notes, task_notes, task_stats)
            .await
    }
...
impl EscaperInternal for ProxyFloatEscaper {
    ...
    async fn _nested_tcp_connect(
        ...
        let peer = self
            .select_peer(task_notes)
            .map_err(TcpConnectError::EscaperNotUsable)?;
        peer.nested_tcp_connect(self, task_conf, egress_notes, task_notes)
            .await
    }
    ...
    async fn _nested_udp_connect(
        ...
        let peer = self
            .select_peer(task_notes)
            .map_err(UdpConnectError::EscaperNotUsable)?;
        peer.nested_udp_connect(self, task_conf, egress_notes, task_notes)
            .await
    }
    ...
    async fn _new_http_forward_connection(
        ...
        let peer = self
            .select_peer(task_notes)
            .map_err(TcpConnectError::EscaperNotUsable)?;
        peer.new_http_forward_connection(self, task_conf, egress_notes, task_notes, task_stats)
            .await
    }
    ...
    async fn _new_https_forward_connection(
        ...
        let peer = self
            .select_peer(task_notes)
            .map_err(TcpConnectError::EscaperNotUsable)?;
        peer.new_https_forward_connection(self, task_conf, egress_notes, task_notes, task_stats)
            .await
    }
