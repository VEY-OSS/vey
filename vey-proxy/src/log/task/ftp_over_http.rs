...
impl TaskLogForFtpOverHttp<'_> {
    ...
    pub(crate) fn log_connected(&self) {
        ...
        slog::info!(self.logger, "";
            ...
            "client_addr" => self.task_notes.client_addr(),
            "upstream" => LtUpstreamAddr(self.ftp_notes.upstream()),
            "escaper" => self.ftp_notes.control_egress_notes.escaper.as_str(),
            "next_bind_ip" => self.ftp_notes.control_egress_notes.bind.ip().map(LtIpAddr),
            "next_expire" => self.ftp_notes.control_egress_notes.expire.as_ref().map(LtDateTime),
            "ftp_c_bound_addr" => self.ftp_notes.control_egress_notes.tcp.local,
            "ftp_c_peer_addr" => self.ftp_notes.control_egress_notes.tcp.peer,
            "ftp_c_connect_tries" => self.ftp_notes.control_egress_notes.tries,
            "ftp_c_connect_spend" => LtDuration(self.ftp_notes.control_egress_notes.duration),
            "method" => LtHttpMethod(&self.ftp_notes.method),
            "uri" => LtHttpUri::new(&self.ftp_notes.uri, self.ftp_notes.uri_log_max_chars),
            "user_agent" => self.http_user_agent,
    ...
    pub(crate) fn log_periodic(&self) {
        ...
        slog::info!(self.logger, "";
            ...
            "ftp_c_connect_tries" => self.ftp_notes.control_egress_notes.tries,
            "ftp_c_connect_spend" => LtDuration(self.ftp_notes.control_egress_notes.duration),
            "ftp_d_bound_addr" => self.ftp_notes.transfer_egress_notes.tcp.local,
            "ftp_d_peer_addr" => self.ftp_notes.transfer_egress_notes.tcp.peer,
            "ftp_d_connect_tries" => self.ftp_notes.transfer_egress_notes.tries,
            "ftp_d_connect_spend" => LtDuration(self.ftp_notes.transfer_egress_notes.duration),
            "method" => LtHttpMethod(&self.ftp_notes.method),
            "uri" => LtHttpUri::new(&self.ftp_notes.uri, self.ftp_notes.uri_log_max_chars),
            "user_agent" => self.http_user_agent,
            "rsp_status" => self.ftp_notes.rsp_status,
