...
impl TaskLogForHttpForward<'_> {
    ...
    pub(crate) fn log_periodic(&self) {
        ...
        slog::info!(self.logger, "";
            ...
            "clt_req_body_size" => self.http_notes.clt_req_body_size,
            "ups_req_body_size" => self.http_notes.ups_req_body_size,
            "ups_rsp_body_size" => self.http_notes.ups_rsp_body_size,
            "clt_rsp_body_size" => self.http_notes.clt_rsp_body_size,
