...
pub(crate) struct TrafficStats {
    ...
    pub(crate) websocket: TcpIoStats,
    pub(crate) h2_connection: TcpIoStats,
    pub(crate) http_connect: TcpIoStats,
    pub(crate) http_connect_udp: UdpIoStats,
...
pub(crate) struct TrafficSnapshot {
    ...
    pub(crate) websocket: TcpIoSnapshot,
    pub(crate) h2_connection: TcpIoSnapshot,
    pub(crate) http_connect: TcpIoSnapshot,
    pub(crate) http_connect_udp: UdpIoSnapshot,
