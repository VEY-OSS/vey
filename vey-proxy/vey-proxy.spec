...
BuildRequires:  jemalloc-devel, c-ares-devel, openssl-devel
...
cargo build --frozen --profile %{build_profile} --no-default-features --features jemalloc,$LUA_FEATURE,python,rustls-ring,quic,$CARES_FEATURE --package vey-proxy --package vey-proxy-ctl --package vey-proxy-lua --package vey-proxy-ftp
...
%changelog
* Sun May 17 2026 VEY-OSS Developers <developers@vey.oss> - 1.13.4-1
